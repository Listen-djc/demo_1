    ...
    <div class="result_wrap">
        <form action="{{url('admin/notice')}}" method="post">
            ...
            <table class="add_tab">
                <tbody>
                <tr>
                    <th width="120">公告所属景区：</th>
                    <td>
                        <select name="sc_id">
                            @foreach($data as $d)
                                <option value="{{$d->sc_id}}">{{$d->sc_name}}</option>
                            @endforeach
                        </select>
                    </td>
                </tr>
                <tr>
                    ...
                    <td>
                        <input type="text" class="lg" name="nt_title">
                    </td>
                </tr>
                <tr>
                    <th>公告内容：</th>
                    <td>
                        ...
                        <script id="editor" name="nt_content" type="text/plain" style="width:860px;height:500px;"></script>
