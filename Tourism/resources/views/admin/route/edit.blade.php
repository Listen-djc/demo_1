...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; 编辑景区
    </div>
    <!--面包屑导航 结束-->
    ...
    <div class="result_wrap">
        <form action="{{url('admin/sceinc/'.$sceinc->sc_id)}}" method="post">
            {{-- PUT方法提交 --}}
            <input type="hidden" name="_method" value="put">
            <input type="hidden" name="sp_id" value="{{$sceinc->sp_id}}">
            {{csrf_field()}}
            <table class="add_tab">
                <tbody>
                <tr>
                    ...
                    <td>
                        <input type="text" name="sc_name" value="{{$sceinc->sc_name}}">
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="sm" name="sc_price" value="{{$sceinc->sc_price}}">
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="sm" name="sc_pre_price" value="{{$sceinc->sc_pre_price}}">
                    </td>
                </tr>
                <tr>
                    <th>状态：</th>
                    <td>
                        <select name="sc_status">
                            <option value="0"
                                    @if($sceinc->sc_status==1)
                                        selected="selected"
                                    @endif
                            >正常使用</option>
                            <option value="0"
                                    @if($sceinc->sc_status==0)
                                    selected="selected"
                                    @endif
                            >停止使用</option>
                        </select>
                ...
                <tr>
                    ...
                    <td>
                        <select name="ad_id">
                            @foreach($admin as $u)
                                <option value="{{$u->ad_id}}"
                                    @if($sceinc->ad_id==$u->ad_id)
                                            selected="selected"
                                        @endif
                                >{{$u->ad_name}}</option>
                            @endforeach
                ...
                <tr>
                    <th>缩略图：</th>
                    <td>
                        <input type="text" size="50" name="sp_picture" value="{{$sceinc->sp_picture}}">
                ...
                <tr>
                    <th></th>
                    <td>
                        <img src="{{asset('/'.$sceinc->sp_picture)}}" alt="" id="art_thumb_img" style="max-width: 300px;max-height: 100px"/>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td>
                        <input type="text" class="lg" name="sc_keyword" value="{{$sceinc->sc_keyword}}">
                ...
                <tr>
                    ...
                    <td>
                        ...
                        <script id="editor" name="sc_introduce" type="text/plain" style="width:860px;height:500px;">{!! $sceinc->sc_introduce !!}</script>
                        <script type="text/javascript">
