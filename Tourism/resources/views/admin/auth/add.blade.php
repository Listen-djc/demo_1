...
@section('content')
    ...
    <div class="crumb_warp">
        ...
        <i class="fa fa-home"></i> <a href="{{url('admin/info')}}">首页</a> &raquo; 添加权限分组
    </div>
    <!--面包屑导航 结束-->
        ...
        <form action="{{url('admin/auth')}}" method="post">
            ...
            <table class="add_tab">
                ...
                <tr>
                    ...
                    <td>
                        <textarea id="" cols="30" rows="10" name="au_describe"></textarea>
                    </td>
                </tr>
                <tr>
                    <th><i class="require">*</i>权限组排序：</th>
                    <td>
                        <input type="text" class="sm" name="au_order" value="0">
                    </td>
                </tr>
                <tr>
                    <th></th>
